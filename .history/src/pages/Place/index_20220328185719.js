...
import { FlatList, StyleSheet, useColorScheme, TouchableOpacity, View, Text, Dimensions, Clipboard, Image, Modal } from 'react-native';
...
export default function PricesProducts({ route }){
  ...
  return(
    <Body>
      ...
      <Modal transparent={true} animationType="slide" visible={modalVisible} item={item}>
        <Container>
          <View style={{
            height: '100%',
            backgroundColor: 'red'
