...
import { FlatList, StyleSheet, useColorScheme, TouchableOpacity, View, Text, Dimensions, Clipboard, Image } from 'react-native';
    ...
    <Body>
      <Container>
        ...
        duration={500}>
          ...
          numColumns={2}
          contentContainerStyle={{ paddingBottom: '15%', justifyContent: 'center' }}
